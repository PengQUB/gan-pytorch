...
parse.add_argument('--lr_decay_start', default=100, type=int)
# parse.add_argument('--lr_decay_rate', default=0.1, type=float)
parse.add_argument('--max_iters', default=None)
parse.add_argument('--epochs', default=5000, type=int)
...
parse.add_argument('--num_workers', default=16*4, type=int)
...
parse.add_argument('--train_image_size', default=500, type=int, help='0 to use original frame size')
parse.add_argument('--val_image_size', default=(500, 500), help='w,h')
